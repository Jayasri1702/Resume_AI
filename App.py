...
connection = pymysql.connect(host='localhost',port=3307,user='root',password='Jsri17@2003',db='cv')
...
def run():
    ...
    link = '[©Developed by Dr,Jaya Sri S](https://www.linkedin.com/in/jaya-sri/)'
